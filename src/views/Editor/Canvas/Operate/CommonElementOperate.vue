...
import type { PPTVideoElement, PPTLatexElement, PPTAudioElement, PPTChartElement, PPTHTMLElement } from '@/types/slides'
...
type PPTElement = PPTVideoElement | PPTLatexElement | PPTAudioElement | PPTChartElement | PPTHTMLElement
