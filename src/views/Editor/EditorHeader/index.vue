    ...
    <div class="left">
      <Popover trigger="click" placement="bottom-start" v-model:value="mainMenuVisible">
        <template #content>
          ...
          <div class="import-section">
            ...
            <div class="import-grid">
              <FileInput class="import-block" accept="application/vnd.openxmlformats-officedocument.presentationml.presentation" @change="files => {
                importPPTXFile(files, { cover: true })
          ...
          <Divider :margin="10" />
          <PopoverMenuItem class="popover-menu-item" @click="setDialogForExport('nativeOverlay')"><i-icon-park-outline:play-one class="icon" /> 同步到 Office / WPS 原生放映</PopoverMenuItem>
