<template>
  ...
  >
    <component
      ...
      :interactive="elementInfo.type === ElementTypes.HTML"
      :key="elementInfo.type === ElementTypes.HTML && elementInfo.restartOnEnter !== false ? `html-${slideIndex}` : elementInfo.id"
    ></component>
  </div>
</template>
...
import BaseHtmlElement from '@/views/components/element/HtmlElement/BaseHtmlElement.vue'
...
const currentElementComponent = computed<unknown>(() => {
  const elementTypeMap = {
    ...
    [ElementTypes.HTML]: BaseHtmlElement,
  }
  return elementTypeMap[props.elementInfo.type] || null
})

const { formatedAnimations, theme, slideIndex } = storeToRefs(useSlidesStore())
